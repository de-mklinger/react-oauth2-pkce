...
import { AuthServiceProps } from '../src/AuthService';
...
const testProps: AuthServiceProps = {
    ...
    prompts: process.env.REACT_APP_PROMPT ? process.env.REACT_APP_PROMPT.split(/\s+/) : ['consent'], // 'consent' required for refresh token
    autoRefresh: true,
